...
export const Sidebar: React.FC<ISidebarProps> = ({ identity }) => (
  <div className="w-10 sm:w-60 border-r border-grey hidden sm:block">
    <div className="w-40 h-40 m-10 p-5 pb-8 font-bold text-blue-dark items-center justify-center bg-gray-100">
      {identity}
    </div>

    <nav>
      <ul className="list-reset text-2xl font-light">
        <li className="pl-5 py-5 hover:bg-gray-100 group flex">
          <svg
            className="w-8 mr-5"
